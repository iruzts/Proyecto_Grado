...
@section('content')
    ...
    <div class="card card">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="/accesorio/{{$accesorio->id}}" method="POST">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre" name="accesorio" placeholder="Introducir Nombre" tabindex="1" value="{{$accesorio->descrip_ac}}">
                        </div>
                    </div>
                </div>
            </div>
